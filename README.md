...
```shell
docker tag nginx:1.27.0 kandlagifari/nginx:0.1.0


# REPOSITORY            TAG         IMAGE ID       CREATED        SIZE
# kandlagifari/nginx    0.1.0       dde0cca083bc   3 weeks ago    188MB
# nginx                 1.27.0      dde0cca083bc   3 weeks ago    188MB
```
...
```shell
docker push kandlagifari/nginx:0.1.0
...
# 0.1.0: digest: sha256:80550935209dd7f6b2d7e8401b9365837e3edd4b047f5a1a7d393e9f04d34498 size: 1778
```
